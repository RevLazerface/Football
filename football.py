...
def main():
    ...
    for i in year_range:
        ...
        for j in week_range:
            ...
            while True:
                ...
                # csv from when I used it before. I was able to run it for just the 2022 season and merge that with the original table 
    ...
    with open('football.csv', 'w', newline='') as output_file:
